...
func ParseFlags() {
	...
	flag.StringVar(&Flags.AzureObjectPrefix, "azure-object-prefix", "", "Prefix for Azure object names")
	flag.StringVar(&Flags.AzureEndpoint, "azure-endpoint", "", "Custom Endpoint to use for Azure BlockBlob Storage (requires azure-storage to be pass)")
